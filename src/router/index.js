...
export const asyncRoutes = [
    ...
    children: [
      {
        ...
        component: () => import('@/views/myVueFiles/fileManage/planningDocuments'),
      ...
      {
        path: 'taskDocuments',
        component: () => import('@/views/myVueFiles/fileManage/taskDocuments'),
        name: 'taskDocuments',
        meta: {
          title: '任务文档',
          roles: ['admin'] // or you can only set roles in sub nav
      ...
      {
        path: 'effectivenessDocuments',
        component: () => import('@/views/myVueFiles/fileManage/effectivenessDocuments'),
        name: 'effectivenessDocuments',
        meta: {
          title: '成效与贡献文档',
          roles: ['admin'] // or you can only set roles in sub nav
        }
  ...
  },
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/myVueFiles/majorProjectRecord/index'),
        name: 'majorProjectRecord',
        meta: { title: '重大项目备案', icon: 'nested', noCache: true }
      }
    ]
  },
  // {
